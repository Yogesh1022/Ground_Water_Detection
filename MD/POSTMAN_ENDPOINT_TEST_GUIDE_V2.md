# Postman Endpoint Testing Guide (Step-by-Step) - V2

This guide helps you test all API endpoints in your Postman collection in the correct order and submit daily test reports.
...
## 8) Daily Test Report Template

Use this section for daily submission.
...
## 9) Copy-Paste Daily Submission Block

Paste this block in your report channel/email after each run:

Date: YYYY-MM-DD
Tester: <name>
Build: <branch/commit/tag>
...
Failed Endpoints:
- <endpoint name> | Expected: <status> | Actual: <status> | Reason: <short reason>
